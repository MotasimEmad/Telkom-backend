    ...
    <div class="px-8 py-4 bg-white rounded-md">
        <div x-cloak x-data="{ modelOpen: false }" class="flex justify-end">
            <button @click="modelOpen =!modelOpen"
                ...
                <span class="mx-1.5">Add New Service</span>
                ...
                <div class="flex items-end justify-center min-h-screen px-4 text-center md:items-center sm:block sm:p-0">
                    ...
                    >
                        <div class="flex items-center justify-between">
                            <h1 class="text-xl font-bold text-gray-800">Add New Service</h1>
                        ...
                        <form id="my-form" class="mt-5" action="{{ route('services.store') }}" method="post"
                              enctype="multipart/form-data">
                            @csrf
                            <div class="mb-4 text-sm">
                                <div class="font-bold mb-2">Service Image</div>
                            ...
                            <div>
                                ...
                                <input placeholder="IT Soultions" type="text" name="name" required
